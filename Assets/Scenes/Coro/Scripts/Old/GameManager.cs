...
{
    public class GameManagersdadssad : GameController
    {
        private static GameManagersdadssad _instance;
        public static GameManagersdadssad Instance
        {
            get
            {
                ...
                if(_instance == null)
                {
                    GameObject go = new GameObject("GameManagersdadssad");
                    go.AddComponent<GameManagersdadssad>();
                    _instance = go.GetComponent<GameManagersdadssad>(); 
                }
                return _instance;
            }
        }
