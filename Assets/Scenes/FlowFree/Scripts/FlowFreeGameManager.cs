...
namespace FlowFree
{
    public class FlowFreeGameManager : GameManager
    {
        ...
        {
            string path = "Assets/Scenes/FlowFree/Levels/" + levelsList[levelIndexList].name + ".txt";
            PaintCell = false;
            TableroLayout.instance.CreateLevel(ReadLevelTxt.ReadTxt(levelsList2[levelIndexList]));
