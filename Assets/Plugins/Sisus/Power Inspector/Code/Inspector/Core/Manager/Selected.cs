	...
	public class Selected
	{
		...
		public IDrawer FocusedDrawer
		{
			get
			{
				...
				{
					UnityEngine.Debug.Assert(focusedDrawer.Selectable, "focusedDrawer "+focusedDrawer+" was not Selectable!");
					UnityEngine.Debug.Assert(focusedDrawer.ShouldShowInInspector, "focusedDrawer "+focusedDrawer+" ShowInInspector was false!");
				}
				#endif
