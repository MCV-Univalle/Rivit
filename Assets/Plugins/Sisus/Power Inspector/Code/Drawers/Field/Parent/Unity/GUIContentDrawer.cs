...
namespace Sisus
{
	...
	public class GUIContentDrawer : ParentFieldDrawer<GUIContent>
	{
		...
		protected override void DoGenerateMemberBuildList()
		{
			...
			memberBuildList.Add(hierarchy.Get(memberInfo, propertyInfoText, "m_text"));
			memberBuildList.Add(hierarchy.Get(memberInfo, propertyInfoImage, "m_image"));
			memberBuildList.Add(hierarchy.Get(memberInfo, propertyInfoTooltip, "m_tooltip"));
		}
