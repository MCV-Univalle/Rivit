	...
	public static class DrawerUtility
	{
		...
		public static MemberInfo GetInspectorViewable(this Type type, bool includeHidden, int nth)
		{
			...
			for(int t = 0; t < 3; t++)
			{
				...
				{
					case Member.Field:
						var fields = type.GetFields(ParentDrawerUtility.BindingFlagsDeclaredInstance);
					...
					case Member.Property:
						var properties = type.GetProperties(ParentDrawerUtility.BindingFlagsDeclaredInstance);
						...
						break;
					case Member.Method:
						var methods = type.GetMethods(ParentDrawerUtility.BindingFlagsDeclaredInstance);
		...
		public static bool CanDrawInSingleRow(Type classMemberType, bool includeHidden)
		{
			...
			var bindingFlags = ParentDrawerUtility.BindingFlagsDeclaredInstanceAndStatic;
