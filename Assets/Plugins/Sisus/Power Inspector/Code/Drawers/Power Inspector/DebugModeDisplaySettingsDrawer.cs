...
namespace Sisus
{
	...
	public sealed class DebugModeDisplaySettingsDrawer : ParentFieldDrawer<DebugModeDisplaySettings>
	{
		...
		public override bool DrawBodySingleRow(Rect position)
		{
			...
			GUI.color = Value.ShowFields ? Color.white : new Color(1f, 1f, 1f, 0.5f);
			...
			GUI.color = Value.ShowProperties ? Color.white : new Color(1f, 1f, 1f, 0.5f);
			...
			GUI.color = Value.ShowMethods ? Color.white : new Color(1f, 1f, 1f, 0.5f);
