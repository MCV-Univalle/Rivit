	...
	public sealed class PreferencesDrawer : AssetWithSideBarDrawer
	{
		...
		private void OnAutoDocumentationUpdated(string url)
		{
			...
			if(!string.Equals(lastShownDocumentationUrl, url))
			{
				...
				StaticCoroutine.LaunchDelayed(0.3f, RestoreDocumentationButtonColor, true);
			}
		}

		private void RestoreDocumentationButtonColor()
		{
			headerButtons[documentationButtonIndex].Color = Color.white;
		}
