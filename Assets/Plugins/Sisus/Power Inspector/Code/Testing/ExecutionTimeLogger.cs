...
namespace Sisus
{
	...
	{
		private Stack<TimedPart> timerStack = new Stack<TimedPart>(5);
		//private Queue<string> intervalTimes = new Queue<string>(10);
		private Stack<string> intervalTimes = new Stack<string>(5);
